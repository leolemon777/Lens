...
- 开放 `.screentrace` 项目包；
- 原生设置与权限中心，覆盖屏幕、麦克风、摄像头和辅助功能；内置严格白名单的本地 JSONL 诊断日志、512 KiB 双文件轮转、异常退出/强退会话检测与可复制诊断摘要，不记录媒体、正文、窗口标题或项目路径；
- 219 项单元、快捷键配置/冲突回退/持久化、捕获几何、录制帧率偏好与元数据兼容、转写语言偏好与设备端 locale 映射、录制重录过渡防护、隐私收敛事件轨/本地诊断日志/会话异常退出检测、对象标注、长截图去重/拼接/源帧归档、非破坏性时间线、真实重叠转场、源时间视频标注、独立音轨、分片归档/合并、磁盘空间预警/安全停止、动态画中画、旁白检测/自动压低、K 加权响度、降噪与音频混合、项目兼容、持久索引、分段转写、字幕时码/分句编辑与烧录、三档导出、本地整理、隐私脱敏、搜索、渲染、UI 快照与媒体集成测试。
