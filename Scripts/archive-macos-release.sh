...
TEMP_DIR="$(mktemp -d "$ARCHIVE_ROOT/.Lens-archive.XXXXXX")"
...
plutil -insert product -string "Lens" "$METADATA_PLIST"
...
plutil -insert sourceSnapshotSHA256 -string "$SOURCE_SNAPSHOT_SHA256" "$METADATA_PLIST"
