...
public struct HotKeyShortcut: Codable, Equatable, Hashable, Sendable {
    ...
    public static let defaultConversationInbox = HotKeyShortcut(
        keyCode: nil,
        modifiers: [.function, .command]
    )
    public static let fallbackConversationInbox = HotKeyShortcut(
        keyCode: 20,
        modifiers: [.control, .option]
    )
...
public struct HotKeyConfiguration: Equatable, Sendable {
    ...
    public var validationError: HotKeyConfigurationError? {
        ...
        guard conversationInbox != .fallbackQuickScreenshot,
              conversationInbox != .fallbackActionCenter else {
            return .conversationInboxConflictsWithFallback
        }
        guard quickScreenshot != .fallbackConversationInbox,
