...
public struct RecordingRecoveryProbe: Equatable, Sendable {
    ...
    public let role: LensAsset.Role
...
public struct RecordingRecoveryAssessment: Equatable, Sendable {
    public enum Finding: Equatable, Hashable, Sendable {
        ...
        case missingDeclaredAsset(relativePath: String, role: LensAsset.Role)
    }
...
public enum RecordingRecoveryPlanner {
    ...
    ///
    /// This deliberately does not look at `LensState`. The damage worth
    ...
    static func isSideTrack(_ role: LensAsset.Role) -> Bool {
        switch role {
