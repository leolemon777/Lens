...
public struct PresenterCameraFrameState: Equatable, Sendable {
    ...
    public init(center: TracePoint, size: Double) {
        self.center = center
        self.size = size
    }
}
...
public enum PresenterCameraPlacementPlanner {
    ...
    private static func cornerStates(
        ...
        return [
            PresenterCameraFrameState(center: TracePoint(x: left, y: top), size: width),
            PresenterCameraFrameState(center: TracePoint(x: right, y: top), size: width),
            PresenterCameraFrameState(center: TracePoint(x: left, y: bottom), size: width),
            PresenterCameraFrameState(center: TracePoint(x: right, y: bottom), size: width)
        ]
    }
    ...
    private static func outputFocus(for camera: CameraFrameState) -> TracePoint {
    ...
    private static func squaredDistance(_ lhs: TracePoint, _ rhs: TracePoint) -> Double {
        let x = lhs.x - rhs.x
        let y = lhs.y - rhs.y
        return x * x + y * y
    }
