...
public struct ScreenshotCanvasStyle: Codable, Equatable, Sendable {
    ...
    public var primaryColor: TraceColor
    public var secondaryColor: TraceColor
    ...
    public init(
        ...
        primaryColor: TraceColor = TraceColor(red: 0.20, green: 0.35, blue: 0.92),
        secondaryColor: TraceColor = TraceColor(red: 0.55, green: 0.22, blue: 0.88),
        padding: Double = 0.08,
...
public struct ScreenshotCanvasLayout: Equatable, Sendable {
    ...
    public let sourceFrame: TraceRect

    public init(outputDimensions: TraceDimensions, sourceFrame: TraceRect) {
...
public enum ScreenshotCanvasPlanner {
    public static func layout(
        ...
        return ScreenshotCanvasLayout(
            outputDimensions: TraceDimensions(width: pixelWidth, height: pixelHeight),
            sourceFrame: TraceRect(
