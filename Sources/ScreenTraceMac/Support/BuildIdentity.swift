...
enum ScreenTraceBuildChannel: String, Codable, CaseIterable, Sendable {
    case development
    case beta
    case release
...
struct BuildIdentity: Codable, Equatable, Sendable {
    ...
    let builtAt: Date?
    let channel: ScreenTraceBuildChannel
    ...
    init(
        ...
        builtAt: Date? = nil,
        channel: ScreenTraceBuildChannel = .development,
        bundleIdentifier: String = "app.screentrace.mac",
    ...
    init(bundle: Bundle) {
        ...
        gitCommit = info["ScreenTraceGitCommit"] as? String ?? Self.unknownCommit
        builtAt = Self.parseBuildDate(info["ScreenTraceBuiltAt"] as? String)
        channel = ScreenTraceBuildChannel(
            infoDictionaryValue: info["ScreenTraceBuildChannel"] as? String
        )
