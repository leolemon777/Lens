...
struct ScreenshotCanvasToolbar: View {
    private struct Preset: Identifiable {
        let id: String
        let primary: TraceColor
        let secondary: TraceColor
    }
    ...
    private var presets: [Preset] {
        [
            Preset(
                id: "蓝紫",
                primary: TraceColor(red: 0.20, green: 0.35, blue: 0.92),
                secondary: TraceColor(red: 0.55, green: 0.22, blue: 0.88)
            ),
            Preset(
                id: "日落",
                primary: TraceColor(red: 1.00, green: 0.36, blue: 0.29),
                secondary: TraceColor(red: 0.98, green: 0.68, blue: 0.25)
            ),
            Preset(
                id: "薄荷",
                primary: TraceColor(red: 0.08, green: 0.68, blue: 0.58),
                secondary: TraceColor(red: 0.18, green: 0.42, blue: 0.88)
            ),
            Preset(
                id: "深色",
                primary: TraceColor(red: 0.06, green: 0.07, blue: 0.11),
                secondary: TraceColor(red: 0.19, green: 0.22, blue: 0.30)
            )
        ]
    }
}
