...
final class ScrollingCapturePlanTests: XCTestCase {
    func testPlanRoundTripsFramePlacementsAndClampsUnsafeMetrics() throws {
        ...
        let plan = ScrollingCapturePlan(
            displayID: 9,
            sourceRect: TraceRect(x: 12, y: 34, width: 500, height: 600),
            viewportDimensions: TraceDimensions(width: 1_000, height: 1_200),
            outputDimensions: TraceDimensions(width: 1_000, height: 4_800),
            frames: [frame]
        )
